...
\begin{table}
	\begin{center}
		\begin{tabular}{lcr}
			...
			\multicolumn{1}{l}{\bf Model}  &\multicolumn{1}{c}{\bf Valid}  &\multicolumn{1}{c}{\bf Test} \\
			...
			\hline
  			...
  			Non-regularized LSTM (BN)	& 130.0 & 123.9 \\

  			\hline

  			Large regularized LSTM		& 82.2 & \textbf{78.4} \\
  			Large regularized LSTM (BN)	& \\
